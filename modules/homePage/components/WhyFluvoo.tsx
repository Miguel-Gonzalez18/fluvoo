  ...
  return (
    <section id="nosotros" className="mx-auto max-w-full px-4 md:px-12 relative py-12">
      <div id="why-fluvoo-header" className="mb-8 text-center">
        ...
        <h2 id="why-fluvoo-title" className="text-3xl font-heading font-bold text-neutral-800">Construido para la <span className="text-primary text-highlight highlight">realidad</span> que vives</h2>
