  ...
  return (
    <section className="w-full max-w-6xl mx-auto relative py-12">
      <div id="why-fluvoo-header" className="mb-8 text-center">
        ...
        <p id="why-fluvoo-description" className="text-neutral-700 mt-2 text-sm max-w-xl mx-auto">Cuatro razones por las que miles de dominicanos están eligiendo Fluvoo para tomar el control de sus finanzas.</p>
      </div>
